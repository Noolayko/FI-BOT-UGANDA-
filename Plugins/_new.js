let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `𝐅𝚰 𝚩𝚯𝚻 𝐔𝐆 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍𝐋𝐄 𝐅𝐎𝐋𝐋𝐎𝐖 𝐑𝐄𝐐_\n *𝐋𝐈𝐍𝐊:* https://whatsapp.com/channel/0029VajvAYL7YScvdKu2dA1r\n\n ${Config.botname} *WORKS*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `𝐅𝚰 𝚩𝚯𝚻 𝐔𝐆 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏\n\n *ʟɪɴᴋ:*https://chat.whatsapp.com/KxVZyInjirjHVmt8LCBtYv \n\n ${Config.botname} *WORKS*`;
