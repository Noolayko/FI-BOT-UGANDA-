...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    // Sending the menu
    conn.sendButton(m.chat, text.replace(), author, pp, [['BOT MENU 🤖', '.botmenu'], ['OWNER MENU 🦉', '.ownermenu'], ['FUN MENU 😂', '.funmenu'], ['FI BOT SPEED 🛫', '.ping']], null, [['SOCIAL 📶', smlink]], m)
